...
public class CcsClient {
    ...
    private String mApiKey = "AIzaSyDLCuqcc_RXK80Z8ttt-eA86gvpH-Po1SQ";
    ...
    private CcsClient(String projectId, String apiKey, boolean debuggable) {
        this();
        mApiKey = "AIzaSyDLCuqcc_RXK80Z8ttt-eA86gvpH-Po1SQ";
    ...
    public static void main(String[] args) {
        final String projectId = "982441941447";
        ...
        final String toRegId ="APA91bHUjlQaApAhr9Wagus5efQFhK9-scPGOBPUV6RHr3kbieIcGDigX4iENZitMBXiwM4ZN0PTcA6DeohU2s28sUDezb5LH7Sl-0shFMgNKpHD4Y03-a40x2ZU9djWeo2JkgT-1_O1";
